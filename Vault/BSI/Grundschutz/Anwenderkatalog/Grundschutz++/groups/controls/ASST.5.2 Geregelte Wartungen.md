...
| - | - | - | - | - | - | - |
| **[Informationen und Assets (ASST)](BSI/Grundschutz/Anwenderkatalog/Grundschutz++/groups/ASST%20Informationen%20und%20Assets.md)**<br> ***  &rarr; [Wartung](BSI/Grundschutz/Anwenderkatalog/Grundschutz++/groups/ASST.5%20Wartung.md) *** | IT-Systeme | SOLLTE | die Wartung | {{regelmäßig oder prädiktiv}} | ausführen | Betriebshandbuch | >Informationen und Assets für IT-Systeme SOLLTE die Wartung {{ insert: param, asst.5.2-prm1 }} ausführen.
