...
| - | - | - | - | - | - | - |
| **[Berechtigung (BER)](BSI/Grundschutz/Anwenderkatalog/Grundschutz++/groups/BER%20Berechtigung.md)**<br> ***  &rarr; [Grundlagen](BSI/Grundschutz/Anwenderkatalog/Grundschutz++/groups/BER.1%20Grundlagen.md) *** |  | MUSS | die Verfahren und Regelungen | {{regelmäßig}} und anlassbezogen auf Aktualität | überprüfen | Prüfplan | >Berechtigung MUSS die Verfahren und Regelungen {{ insert: param, ber.1.2-prm1 }} und anlassbezogen auf Aktualität überprüfen.
