...
| - | - | - | - | - | - | - |
| **[Beschaffungsmanagement (BES)](BSI/Grundschutz/Anwenderkatalog/Grundschutz++/groups/BES%20Beschaffungsmanagement.md)**<br> ***  &rarr; [Kompensierende Kontrollmechanismen](BSI/Grundschutz/Anwenderkatalog/Grundschutz++/groups/BES.8%20Kompensierende%20Kontrollmechanismen.md) *** | Outsourcing | KANN | Verfahren zur Übertragung von Geschäftsprozessen | für den Fall einer geplanten oder ungeplanten Beendigung des Vertrages | verankern | Geschäftsprozesse | >Beschaffungsmanagement für Outsourcing KANN Verfahren zur Übertragung von Geschäftsprozessen für den Fall einer geplanten oder ungeplanten Beendigung des Vertrages verankern.
