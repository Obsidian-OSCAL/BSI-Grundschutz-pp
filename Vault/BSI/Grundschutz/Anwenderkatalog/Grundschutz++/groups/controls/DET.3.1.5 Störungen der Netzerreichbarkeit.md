...
| - | - | - | - | - | - | - |
| **[Detektion (DET)](BSI/Grundschutz/Anwenderkatalog/Grundschutz++/groups/DET%20Detektion.md)**<br> ***  &rarr; [Protokollierung](BSI/Grundschutz/Anwenderkatalog/Grundschutz++/groups/DET.3%20Protokollierung.md) *** | IT-Systeme | KANN | Störungen der Netzerreichbarkeit |  | protokollieren | Audit Log | >Detektion für IT-Systeme KANN Störungen der Netzerreichbarkeit protokollieren.
