...
| - | - | - | - | - | - | - |
| **[Gebäudemanagement (GEB)](BSI/Grundschutz/Anwenderkatalog/Grundschutz++/groups/GEB%20Gebäudemanagement.md)**<br> ***  &rarr; [Versorgungseinrichtungen](BSI/Grundschutz/Anwenderkatalog/Grundschutz++/groups/GEB.9%20Versorgungseinrichtungen.md) *** | Standorte | KANN | eine Notausschaltung für die Versorgungseinrichtungen |  | installieren | Gebäudedokumentation | >Gebäudemanagement für Standorte KANN eine Notausschaltung für die Versorgungseinrichtungen installieren.
