...
| - | - | - | - | - | - | - |
| **[Konfiguration (KONF)](BSI/Grundschutz/Anwenderkatalog/Grundschutz++/groups/KONF%20Konfiguration.md)**<br> ***  &rarr; [Konfiguration von Systemen](BSI/Grundschutz/Anwenderkatalog/Grundschutz++/groups/KONF.2%20Konfiguration%20von%20Systemen.md) *** | IT-Systeme | KANN | einen abgesicherten und authentisierten Bootprozess |  | aktivieren | Konfigurationshistorie | >Konfiguration für IT-Systeme KANN einen abgesicherten und authentisierten Bootprozess aktivieren.
