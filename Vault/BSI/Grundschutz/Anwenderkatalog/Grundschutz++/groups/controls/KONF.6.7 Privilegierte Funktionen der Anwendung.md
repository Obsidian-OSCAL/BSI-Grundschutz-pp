...
| - | - | - | - | - | - | - |
| **[Konfiguration (KONF)](BSI/Grundschutz/Anwenderkatalog/Grundschutz++/groups/KONF%20Konfiguration.md)**<br> ***  &rarr; [Rollen und Berechtigungen](BSI/Grundschutz/Anwenderkatalog/Grundschutz++/groups/KONF.6%20Rollen%20und%20Berechtigungen.md) *** | Anwendungen | SOLLTE | privilegierte Funktionen |  | einschränken | Konfigurationshistorie | >Konfiguration für Anwendungen SOLLTE privilegierte Funktionen einschränken.
