...
| - | - | - | - | - | - | - |
| **[Notfallplanung (NOT)](BSI/Grundschutz/Anwenderkatalog/Grundschutz++/groups/NOT%20Notfallplanung.md)**<br> ***  &rarr; [Notfallvorsorge](BSI/Grundschutz/Anwenderkatalog/Grundschutz++/groups/NOT.3%20Notfallvorsorge.md) *** |  | KANN | die tatsächliche Funktionstüchtigkeit von Notfallplänen | {{regelmäßig}} | überprüfen | Übungsplan | >Notfallplanung KANN die tatsächliche Funktionstüchtigkeit von Notfallplänen {{ insert: param, not.3.4-prm1 }} überprüfen.
