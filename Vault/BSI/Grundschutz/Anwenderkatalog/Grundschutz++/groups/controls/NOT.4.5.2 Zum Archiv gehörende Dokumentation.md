...
| - | - | - | - | - | - | - |
| **[Notfallplanung (NOT)](BSI/Grundschutz/Anwenderkatalog/Grundschutz++/groups/NOT%20Notfallplanung.md)**<br> ***  &rarr; [Datensicherung](BSI/Grundschutz/Anwenderkatalog/Grundschutz++/groups/NOT.4%20Datensicherung.md) *** | Daten | SOLLTE | die Archivierung von Dokumentationen, die zur Verwendung von archivierten Daten erforderlich sind, | {{regelmäßig}} | ausführen | Datensicherungskonzept | >Notfallplanung für Daten SOLLTE die Archivierung von Dokumentationen, die zur Verwendung von archivierten Daten erforderlich sind, {{ insert: param, not.4.5.2-prm1 }} ausführen.
