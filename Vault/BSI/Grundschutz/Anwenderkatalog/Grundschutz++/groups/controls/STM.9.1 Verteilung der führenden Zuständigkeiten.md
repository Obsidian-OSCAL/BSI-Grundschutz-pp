...
| - | - | - | - | - | - | - |
| **[Strukturmodellierung (STM)](BSI/Grundschutz/Anwenderkatalog/Grundschutz++/groups/STM%20Strukturmodellierung.md)**<br> ***  &rarr; [Gestaltungsentscheidungen](BSI/Grundschutz/Anwenderkatalog/Grundschutz++/groups/STM.9%20Gestaltungsentscheidungen.md) *** |  | MUSS | jeder Anforderung eine zuständige Person oder Rolle | für den zugeordneten Prozess | zuweisen |  | >Strukturmodellierung MUSS jeder Anforderung eine zuständige Person oder Rolle für den zugeordneten Prozess zuweisen.
