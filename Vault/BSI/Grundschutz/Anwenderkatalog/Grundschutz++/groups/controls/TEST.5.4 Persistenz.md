...
| - | - | - | - | - | - | - |
| **[Änderungen und Tests (TEST)](BSI/Grundschutz/Anwenderkatalog/Grundschutz++/groups/TEST%20Änderungen%20und%20Tests.md)**<br> ***  &rarr; [Bereitstellung](BSI/Grundschutz/Anwenderkatalog/Grundschutz++/groups/TEST.5%20Bereitstellung.md) *** |  | SOLLTE | die Persistenz | nach wesentlichen Änderungen | testen | Konfigurationshistorie | >Änderungen und Tests SOLLTE die Persistenz nach wesentlichen Änderungen testen.
