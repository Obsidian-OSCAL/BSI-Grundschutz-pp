...
| - | - | - | - | - | - | - |
| **[Architektur (ARCH)](BSI/Grundschutz/Quellkataloge/Kernel/groups/ARCH%20Architektur.md)**<br> ***  &rarr; [Grundlagen](BSI/Grundschutz/Quellkataloge/Kernel/groups/ARCH.1%20Grundlagen.md) *** |  | MUSS | die mit den Verfahren und Regelungen verbundenen Aufgaben | {{zuständigen Personen oder Rollen}} | zuweisen | Geschäftsverteilungsplan | >Architektur MUSS die mit den Verfahren und Regelungen verbundenen Aufgaben {{ insert: param, arch.1.1.2-prm1 }} zuweisen.
