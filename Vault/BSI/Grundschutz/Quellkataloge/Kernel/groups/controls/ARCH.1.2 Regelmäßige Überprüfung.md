...
| - | - | - | - | - | - | - |
| **[Architektur (ARCH)](BSI/Grundschutz/Quellkataloge/Kernel/groups/ARCH%20Architektur.md)**<br> ***  &rarr; [Grundlagen](BSI/Grundschutz/Quellkataloge/Kernel/groups/ARCH.1%20Grundlagen.md) *** |  | MUSS | die Verfahren und Regelungen | {{regelmäßig}} und anlassbezogen auf Aktualität | überprüfen | Übungs- und Prüfplan | >Architektur MUSS die Verfahren und Regelungen {{ insert: param, arch.1.2-prm1 }} und anlassbezogen auf Aktualität überprüfen.
