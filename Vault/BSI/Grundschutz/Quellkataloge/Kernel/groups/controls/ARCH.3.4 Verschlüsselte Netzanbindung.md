...
| - | - | - | - | - | - | - |
| **[Architektur (ARCH)](BSI/Grundschutz/Quellkataloge/Kernel/groups/ARCH%20Architektur.md)**<br> ***  &rarr; [Wireless LAN](BSI/Grundschutz/Quellkataloge/Kernel/groups/ARCH.3%20Wireless%20LAN.md) *** | WLANs | SOLLTE | die Netzanbindung | {{nach einem anerkannten Standard}} | verschlüsseln | Konfigurationshistorie | >Architektur für WLANs SOLLTE die Netzanbindung {{ insert: param, arch.3.4-prm1 }} verschlüsseln.
