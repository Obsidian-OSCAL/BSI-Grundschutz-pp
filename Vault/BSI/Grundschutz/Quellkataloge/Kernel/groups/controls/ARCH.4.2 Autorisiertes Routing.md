...
| - | - | - | - | - | - | - |
| **[Architektur (ARCH)](BSI/Grundschutz/Quellkataloge/Kernel/groups/ARCH%20Architektur.md)**<br> ***  &rarr; [Zugangsbeschränkungen](BSI/Grundschutz/Quellkataloge/Kernel/groups/ARCH.4%20Zugangsbeschränkungen.md) *** | Netze | SOLLTE | Routing-Verbindungen | durch {{eine zuständige Person oder Rolle}} | autorisieren | Konfigurationshistorie | >Architektur für Netze SOLLTE Routing-Verbindungen durch {{ insert: param, arch.4.2-prm1 }} autorisieren.
