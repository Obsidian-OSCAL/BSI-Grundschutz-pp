...
| - | - | - | - | - | - | - |
| **[Architektur (ARCH)](BSI/Grundschutz/Quellkataloge/Kernel/groups/ARCH%20Architektur.md)**<br> ***  &rarr; [Ausfallsicherheit](BSI/Grundschutz/Quellkataloge/Kernel/groups/ARCH.8%20Ausfallsicherheit.md) *** | Netze | SOLLTE | für das Kernnetz redundante Netzkomponenten |  | installieren | Konfigurationshistorie | >Architektur für Netze SOLLTE für das Kernnetz redundante Netzkomponenten installieren.
