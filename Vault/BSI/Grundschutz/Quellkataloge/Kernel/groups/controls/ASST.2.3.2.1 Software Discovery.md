...
| - | - | - | - | - | - | - |
| **[Informationen und Assets (ASST)](BSI/Grundschutz/Quellkataloge/Kernel/groups/ASST%20Informationen%20und%20Assets.md)**<br> ***  &rarr; [Inventarisierung](BSI/Grundschutz/Quellkataloge/Kernel/groups/ASST.2%20Inventarisierung.md) *** |  | KANN | die Aktualität des Inventars der Anwendungen durch ein automatisiertes Verfahren | {{regelmäßig oder bei Änderungen}} | überprüfen | IT-Betriebskonzept | >Informationen und Assets KANN die Aktualität des Inventars der Anwendungen durch ein automatisiertes Verfahren {{ insert: param, asst.2.3.2.1-prm1 }} überprüfen.
