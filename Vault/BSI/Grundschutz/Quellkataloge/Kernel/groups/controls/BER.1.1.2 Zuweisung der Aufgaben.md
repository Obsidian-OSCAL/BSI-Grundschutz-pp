...
| - | - | - | - | - | - | - |
| **[Berechtigung (BER)](BSI/Grundschutz/Quellkataloge/Kernel/groups/BER%20Berechtigung.md)**<br> ***  &rarr; [Grundlagen](BSI/Grundschutz/Quellkataloge/Kernel/groups/BER.1%20Grundlagen.md) *** |  | MUSS | die mit den Verfahren und Regelungen verbundenen Aufgaben | {{zuständigen Personen oder Rollen}} | zuweisen | Geschäftsverteilungsplan | >Berechtigung MUSS die mit den Verfahren und Regelungen verbundenen Aufgaben {{ insert: param, ber.1.1.2-prm1 }} zuweisen.
