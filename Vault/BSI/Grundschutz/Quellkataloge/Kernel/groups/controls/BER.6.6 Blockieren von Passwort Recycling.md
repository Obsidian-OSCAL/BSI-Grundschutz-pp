...
| - | - | - | - | - | - | - |
| **[Berechtigung (BER)](BSI/Grundschutz/Quellkataloge/Kernel/groups/BER%20Berechtigung.md)**<br> ***  &rarr; [Passwortgebrauch](BSI/Grundschutz/Quellkataloge/Kernel/groups/BER.6%20Passwortgebrauch.md) *** | Nutzende | SOLLTE | die Wiederverwendung von Passwörtern |  | blockieren | Konfigurationshistorie | >Berechtigung für Nutzende SOLLTE die Wiederverwendung von Passwörtern blockieren.
