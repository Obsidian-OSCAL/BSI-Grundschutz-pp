...
| - | - | - | - | - | - | - |
| **[Detektion (DET)](BSI/Grundschutz/Quellkataloge/Kernel/groups/DET%20Detektion.md)**<br> ***  &rarr; [Protokollierung](BSI/Grundschutz/Quellkataloge/Kernel/groups/DET.3%20Protokollierung.md) *** | IT-Systeme | SOLLTE | das Anschließen von Peripheriegeräten |  | protokollieren | Audit Log | >Detektion für IT-Systeme SOLLTE das Anschließen von Peripheriegeräten protokollieren.
