...
| - | - | - | - | - | - | - |
| **[Detektion (DET)](BSI/Grundschutz/Quellkataloge/Kernel/groups/DET%20Detektion.md)**<br> ***  &rarr; [Protokollierung](BSI/Grundschutz/Quellkataloge/Kernel/groups/DET.3%20Protokollierung.md) *** | Anwendungen | SOLLTE | Fehlermeldungen der Anwendung |  | protokollieren | Audit Log | >Detektion für Anwendungen SOLLTE Fehlermeldungen der Anwendung protokollieren.
