...
| - | - | - | - | - | - | - |
| **[Detektion (DET)](BSI/Grundschutz/Quellkataloge/Kernel/groups/DET%20Detektion.md)**<br> ***  &rarr; [Überwachung von Aktivitäten](BSI/Grundschutz/Quellkataloge/Kernel/groups/DET.4%20Überwachung%20von%20Aktivitäten.md) *** | Verzeichnisdienste | KANN | das Verhalten von Zugangskonten |  | überwachen | Detektions-Konzept | >Detektion für Verzeichnisdienste KANN das Verhalten von Zugangskonten überwachen.
