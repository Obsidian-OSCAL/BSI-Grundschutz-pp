...
| - | - | - | - | - | - | - |
| **[Gebäudemanagement (GEB)](BSI/Grundschutz/Quellkataloge/Kernel/groups/GEB%20Gebäudemanagement.md)**<br> ***  &rarr; [Schutz vor Elementarschäden](BSI/Grundschutz/Quellkataloge/Kernel/groups/GEB.10%20Schutz%20vor%20Elementarschäden.md) *** | Räume | SOLLTE | Brandabschnitte | nach den entsprechenden Normen | installieren | Gebäudedokumentation | >Gebäudemanagement für Räume SOLLTE Brandabschnitte nach den entsprechenden Normen installieren.
