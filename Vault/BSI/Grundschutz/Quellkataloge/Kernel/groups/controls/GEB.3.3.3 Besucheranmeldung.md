...
| - | - | - | - | - | - | - |
| **[Gebäudemanagement (GEB)](BSI/Grundschutz/Quellkataloge/Kernel/groups/GEB%20Gebäudemanagement.md)**<br> ***  &rarr; [Physischer Zutritt](BSI/Grundschutz/Quellkataloge/Kernel/groups/GEB.3%20Physischer%20Zutritt.md) *** | Standorte | SOLLTE | Besuche | durch {{eine zuständige Person oder Rolle}} | autorisieren | Prozess Gebäudemanagement | >Gebäudemanagement für Standorte SOLLTE Besuche durch {{ insert: param, geb.3.3.3-prm1 }} autorisieren.
