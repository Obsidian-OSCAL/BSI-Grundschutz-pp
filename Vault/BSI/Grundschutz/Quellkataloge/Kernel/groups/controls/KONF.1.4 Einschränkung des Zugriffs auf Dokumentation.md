...
| - | - | - | - | - | - | - |
| **[Konfiguration (KONF)](BSI/Grundschutz/Quellkataloge/Kernel/groups/KONF%20Konfiguration.md)**<br> ***  &rarr; [Grundlagen](BSI/Grundschutz/Quellkataloge/Kernel/groups/KONF.1%20Grundlagen.md) *** |  | SOLLTE | den Zugriff auf dokumentierte Konfigurationen |  | einschränken | Konfigurationshistorie | >Konfiguration SOLLTE den Zugriff auf dokumentierte Konfigurationen einschränken.
