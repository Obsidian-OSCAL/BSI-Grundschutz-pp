...
| - | - | - | - | - | - | - |
| **[Konfiguration (KONF)](BSI/Grundschutz/Quellkataloge/Kernel/groups/KONF%20Konfiguration.md)**<br> ***  &rarr; [Kontrollierte Datenverarbeitung](BSI/Grundschutz/Quellkataloge/Kernel/groups/KONF.12%20Kontrollierte%20Datenverarbeitung.md) *** | Webbrowser | KANN | die dauerhafte Browser-Historie |  | deaktivieren | Konfigurationshistorie | >Konfiguration für Webbrowser KANN die dauerhafte Browser-Historie deaktivieren.
