...
| - | - | - | - | - | - | - |
| **[Konfiguration (KONF)](BSI/Grundschutz/Quellkataloge/Kernel/groups/KONF%20Konfiguration.md)**<br> ***  &rarr; [Verteilte Anwendungen](BSI/Grundschutz/Quellkataloge/Kernel/groups/KONF.14%20Verteilte%20Anwendungen.md) *** | DNS-Server | SOLLTE | Source Port Randomisierung |  | aktivieren | Konfigurationshistorie | >Konfiguration für DNS-Server SOLLTE Source Port Randomisierung aktivieren.
