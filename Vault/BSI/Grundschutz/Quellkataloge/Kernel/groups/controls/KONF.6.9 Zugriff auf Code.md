...
| - | - | - | - | - | - | - |
| **[Konfiguration (KONF)](BSI/Grundschutz/Quellkataloge/Kernel/groups/KONF%20Konfiguration.md)**<br> ***  &rarr; [Rollen und Berechtigungen](BSI/Grundschutz/Quellkataloge/Kernel/groups/KONF.6%20Rollen%20und%20Berechtigungen.md) *** | Webserver | SOLLTE | den Zugriff auf Quelldateien |  | einschränken | Konfigurationshistorie | >Konfiguration für Webserver SOLLTE den Zugriff auf Quelldateien einschränken.
