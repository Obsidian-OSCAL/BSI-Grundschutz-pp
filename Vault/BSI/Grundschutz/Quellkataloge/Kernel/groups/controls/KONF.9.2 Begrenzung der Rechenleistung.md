...
| - | - | - | - | - | - | - |
| **[Konfiguration (KONF)](BSI/Grundschutz/Quellkataloge/Kernel/groups/KONF%20Konfiguration.md)**<br> ***  &rarr; [Verfügbarkeit von Ressourcen](BSI/Grundschutz/Quellkataloge/Kernel/groups/KONF.9%20Verfügbarkeit%20von%20Ressourcen.md) *** | Hostsysteme | KANN | die zur Verfügung stehende Rechenleistung | anhand von {{Schwellwerten}} | einschränken | Konfigurationshistorie | >Konfiguration für Hostsysteme KANN die zur Verfügung stehende Rechenleistung anhand von {{ insert: param, konf.9.2-prm1 }} einschränken.
