...
| - | - | - | - | - | - | - |
| **[Personal (PERS)](BSI/Grundschutz/Quellkataloge/Kernel/groups/PERS%20Personal.md)**<br> ***  &rarr; [Grundlagen](BSI/Grundschutz/Quellkataloge/Kernel/groups/PERS.1%20Grundlagen.md) *** |  | MUSS | die Verfahren und Regelungen | {{regelmäßig}} und anlassbezogen auf Aktualität | überprüfen | Übungs- und Prüfplan | >Personal MUSS die Verfahren und Regelungen {{ insert: param, pers.1.2-prm1 }} und anlassbezogen auf Aktualität überprüfen.
