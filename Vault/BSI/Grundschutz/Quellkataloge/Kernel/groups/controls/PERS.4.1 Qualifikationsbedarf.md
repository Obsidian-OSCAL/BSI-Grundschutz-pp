...
| - | - | - | - | - | - | - |
| **[Personal (PERS)](BSI/Grundschutz/Quellkataloge/Kernel/groups/PERS%20Personal.md)**<br> ***  &rarr; [Personalentwicklung](BSI/Grundschutz/Quellkataloge/Kernel/groups/PERS.4%20Personalentwicklung.md) *** | Mitarbeitende | SOLLTE | den Bedarf an Qualifikationsmaßnahmen anhand der Aufgaben | {{regelmäßig}} | überprüfen | Schulungsplan | >Personal für Mitarbeitende SOLLTE den Bedarf an Qualifikationsmaßnahmen anhand der Aufgaben {{ insert: param, pers.4.1-prm1 }} überprüfen.
