...
| - | - | - | - | - | - | - |
| **[Personal (PERS)](BSI/Grundschutz/Quellkataloge/Kernel/groups/PERS%20Personal.md)**<br> ***  &rarr; [Personalbetreuung](BSI/Grundschutz/Quellkataloge/Kernel/groups/PERS.5%20Personalbetreuung.md) *** |  | SOLLTE | die Vertrauenswürdigkeit für {{definierte sicherheitskritische Rollen}} | {{regelmäßig}} und anlassbezogen | überprüfen | Prozess Personalmanagement | >Personal SOLLTE die Vertrauenswürdigkeit für {{ insert: param, pers.5.3-prm1 }} {{ insert: param, pers.5.3-prm2 }} und anlassbezogen überprüfen.
