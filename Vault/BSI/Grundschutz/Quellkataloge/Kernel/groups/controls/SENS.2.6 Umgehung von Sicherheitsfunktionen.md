...
| - | - | - | - | - | - | - |
| **[Sensibilisierung (SENS)](BSI/Grundschutz/Quellkataloge/Kernel/groups/SENS%20Sensibilisierung.md)**<br> ***  &rarr; [Grundlegende Sensibilisierung](BSI/Grundschutz/Quellkataloge/Kernel/groups/SENS.2%20Grundlegende%20Sensibilisierung.md) *** | Nutzende | SOLLTE | gegen die Umgehung von Sicherheitsfunktionen |  | sensibilisieren | Schulungsplan | >Sensibilisierung für Nutzende SOLLTE gegen die Umgehung von Sicherheitsfunktionen sensibilisieren.
