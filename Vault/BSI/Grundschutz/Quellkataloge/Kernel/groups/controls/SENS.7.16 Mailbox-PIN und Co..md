...
| - | - | - | - | - | - | - |
| **[Sensibilisierung (SENS)](BSI/Grundschutz/Quellkataloge/Kernel/groups/SENS%20Sensibilisierung.md)**<br> ***  &rarr; [Umgang mit spezifischen Zielobjekten](BSI/Grundschutz/Quellkataloge/Kernel/groups/SENS.7%20Umgang%20mit%20spezifischen%20Zielobjekten.md) *** | Nutzende, TK-Anwendungen | SOLLTE | zur Vergabe eigener Zugangsdaten zum Zugriff auf Aufzeichnungen |  | sensibilisieren | Schulungsplan | >Sensibilisierung für Nutzende von TK-Anwendungen SOLLTE zur Vergabe eigener Zugangsdaten zum Zugriff auf Aufzeichnungen sensibilisieren.
