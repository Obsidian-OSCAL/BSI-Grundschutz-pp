...
| - | - | - | - | - | - | - |
| **[Änderungen und Tests (TEST)](BSI/Grundschutz/Quellkataloge/Kernel/groups/TEST%20Änderungen%20und%20Tests.md)**<br> ***  &rarr; [Bereitstellung](BSI/Grundschutz/Quellkataloge/Kernel/groups/TEST.5%20Bereitstellung.md) *** |  | KANN | die Inbetriebnahme | stufenweise | ausführen | Konfigurationshistorie | >Änderungen und Tests KANN die Inbetriebnahme stufenweise ausführen.
